...
try:
    ...
    try:
        ...
        HAS_CYTHON = False
        print("Warning: Cython decryptor not found, falling back to pure Python (slower).")


def decrypt_bundle(
    data: bytearray, region: str = "jp", key: int = DEFAULT_KEY, base_keys: bytes = DEFAULT_BASE_KEYS
) -> bytearray:
