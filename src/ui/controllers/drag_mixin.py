...
class DragMixin:
    def _on_mouse_move(self, sender, app_data):
        ...
        if dpg.is_mouse_button_down(dpg.mvMouseButton_Middle):
            if not self.middle_drag_active:
                self._on_middle_mouse_down(None, None)
    ...
    def _on_middle_mouse_drag(self, sender, app_data):
    ...
    def _on_middle_mouse_release(self, sender, app_data):
    ...
    def _on_left_mouse_release(self, sender, app_data):
